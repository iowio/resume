...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download PDF](https://github.com/iowio/cv/raw/master/muge_resume.pdf)")
}
```
...
The source code is available [on github.com/iowio/resume](https://github.com/iowio/resume).
